...
INSERT OR REPLACE INTO sm_lineups
  ...
  (9000002, 9100001, 9410001, 'Gonda',        12,'24', '1:1', 1, NULL, 1781000000),
  (9000002, 9100001, 9410002, 'Sakai',         5, '25', '2:1', 1, NULL, 1781000000),
  (9000002, 9100001, 9410003, 'Itakura',       3, '25', '2:2', 1, NULL, 1781000000),
  (9000002, 9100001, 9410004, 'Yoshida',       4, '25', '2:3', 1, NULL, 1781000000),
  (9000002, 9100001, 9410005, 'Nagatomo',      2, '25', '2:4', 1, NULL, 1781000000),
  (9000002, 9100001, 9410006, 'Wataru Endo',   6, '26', '3:1', 1, 0.10, 1781000000),
  (9000002, 9100001, 9410007, 'Morita',       13, '26', '3:2', 1, 0.05, 1781000000),
  (9000002, 9100001, 9410008, 'Kaoru Mitoma', 14, '26', '4:1', 1, 0.58, 1781000000),
  (9000002, 9100001, 9410009, 'Kamada',        8, '26', '4:2', 1, 0.22, 1781000000),
  (9000002, 9100001, 9410010, 'Ritsu Doan',    9, '26', '4:3', 1, 0.31, 1781000000),
  (9000002, 9100001, 9410011, 'Takuma Asano', 15, '27', '5:1', 1, 0.24, 1781000000),
  -- JPN 控え3（formation_field NULL = ベンチ）
  (9000002, 9100001, 9410012, 'Ito',          16, '26', NULL,  0, NULL, 1781000000),
  (9000002, 9100001, 9410013, 'Ueda',         20, '27', NULL,  0, NULL, 1781000000),
  (9000002, 9100001, 9410014, 'Tomiyasu',     19, '25', NULL,  0, NULL, 1781000000),
  -- GER 先発11（4-3-3: GK / DF4 / MF3 / FW3）
  (9000002, 9100002, 9420001, 'Neuer',         1, '24', '1:1', 1, NULL, 1781000000),
  (9000002, 9100002, 9420002, 'Kimmich',       6, '25', '2:1', 1, NULL, 1781000000),
  (9000002, 9100002, 9420003, 'Ruediger',      2, '25', '2:2', 1, NULL, 1781000000),
  (9000002, 9100002, 9420004, 'Tah',           4, '25', '2:3', 1, NULL, 1781000000),
  (9000002, 9100002, 9420005, 'Raum',         22, '25', '2:4', 1, NULL, 1781000000),
  (9000002, 9100002, 9420006, 'Andrich',      23, '26', '3:1', 1, 0.07, 1781000000),
  (9000002, 9100002, 9420007, 'Goretzka',      8, '26', '3:2', 1, 0.18, 1781000000),
  (9000002, 9100002, 9420008, 'Musiala',      10, '26', '3:3', 1, 0.29, 1781000000),
  (9000002, 9100002, 9420009, 'Sane',         19, '27', '4:1', 1, 0.41, 1781000000),
  (9000002, 9100002, 9420010, 'Havertz',       7, '27', '4:2', 1, 0.36, 1781000000),
  (9000002, 9100002, 9420011, 'Wirtz',        17, '27', '4:3', 1, 0.27, 1781000000),
  -- GER 控え2
  (9000002, 9100002, 9420012, 'Fuellkrug',     9, '27', NULL,  0, NULL, 1781000000),
  (9000002, 9100002, 9420013, 'Gundogan',     21, '26', NULL,  0, NULL, 1781000000);
