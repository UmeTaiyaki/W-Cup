...
(() => {
	...
	// app_code ペアをキーに地上波局を保持。R32 以降の確定カードは実コードペア、
	// 勝者未確定の R16 以降は 'W74|W77' のような勝者スロット表記でキー化する。
	...
	window.WC.MEDIA_TERRESTRIAL = {
		...
		"COL|POR": ["フジ"],
		"ARG|JOR": ["NHK"],
		// ── 決勝トーナメント（地上波が確定したカードのみ。他は順次発表）──
		"BRA|JPN": ["フジ"], // R32 #76 ブラジル×日本（地上波フジ＋BS NHK BS）
		"W74|W77": ["日テレ"], // R16 #89（7/5 06:00 日本テレビ）
		"W83|W84": ["日テレ"], // R16 #93（7/7 04:00 日本テレビ）
	};
