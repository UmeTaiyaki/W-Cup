...
(() => {
	...
	const CRY = {
		...
		NZL: "GO ALL WHITES!",
		CZE: "DO TOHO ČESKO!",
		SVK: "DO TOHO SLOVENSKO!",
		HUN: "HAJRÁ MAGYAROK!",
		ROU: "HAI ROMÂNIA!",
		SVN: "NAPREJ SLOVENIJA!",
		ISL: "ÁFRAM ÍSLAND!",
		IRL: "COME ON YOU BOYS IN GREEN!",
		FIN: "SUOMI, SUOMI!",
		CHN: "中国加油！",
		UZB: "OLG'A O'ZBEKISTON!",
		IRQ: "هيا العراق!",
		UAE: "يلا الإمارات!",
		JOR: "هيا الأردن!",
		THA: "สู้ๆ ไทย!",
		...
		IDN: "AYO INDONESIA!",
		IND: "CHAK DE INDIA!",
		BFA: "ALLEZ LES ÉTALONS!",
		MLI: "ALLEZ LES AIGLES!",
		COD: "ALLEZ LES LÉOPARDS!",
		ZAM: "GO CHIPOLOPOLO!",
		CPV: "FORÇA CABO VERDE!",
		ANG: "FORÇA ANGOLA!",
	};
