// 自動生成（scripts/fetch-third-allocation.mjs）— 手で編集しないこと。
// FIFA 2026 W杯 Annex C: 3位通過チームの組み合わせ表（495通り）。
// キー = 3位通過した8グループ（昇順）/ 値 = 勝者順 ABDEGIKL に割り当てる3位グループ。
// 例: 'EFGHIJKL' -> 'EJIFHGLK' は A1の相手=3E, B1=3J, D1=3I, E1=3F, G1=3H, I1=3G, K1=3L, L1=3K。
export const WINNER_ORDER = ["A","B","D","E","G","I","K","L"];
export const WINNER_SLOT = {"A":"M11","B":"M15","D":"M7","E":"M1","G":"M8","I":"M2","K":"M16","L":"M12"};
